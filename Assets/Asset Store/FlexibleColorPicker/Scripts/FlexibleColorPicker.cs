...
public class FlexibleColorPicker : MonoBehaviour {
    ...
    */
    ...
    [FormerlySerializedAs("startingClorRaisesColorChangeEvent")] [SerializeField] private bool startingColorRaisesColorChangeEvent;
    private void OnEnable() {
        ...
        UpdateMarkers();
        UpdateHex();
        if(this.startingColorRaisesColorChangeEvent)
